...
\usepackage{appendix} 
\usepackage{xcolor} 
\definecolor{chapitrecolor}{RGB}{47, 0, 255}
\definecolor{sectioncolor}{RGB}{0, 100, 255} 
\definecolor{subsectioncolor}{RGB}{60, 0, 100} 
\definecolor{subsubsectioncolor}{RGB}{5, 35, 10} 
...
\begin{document}
	...
	\titre{stage à l'hopital} 
	
	\sujet{Rapporte de stage \\ d'initiation} 
	
	\Encadrants{\textbf{ Leila \textsc{Ennaceur Arjoun}}} 
	
	\eleves{\textbf{Oussama \textsc{Halmous}}} 
